...
Upload the notebooks from <a href="https://github.com/ssciwr/BioStructureHub/tree/main/notebooks" target="_blank" rel="noopener">our github</a> and the <a href="https://github.com/martinpacesa/BindCraft/blob/main/example/PDL1.pdb" target="_blank" rel="noopener">PDL1.pdb</a> file by clicking on the upload button:
...
![Screenshot](../images/tutorial/bwVisu_Bindcraft_input.png){: .invertable style="width:268px"}
...
![Screenshot](../images/tutorial/bwVisu_Bindcraft_modules_loaded.png){: .invertable style="width:378px"}
...
![Screenshot](../images/tutorial/bwVisu_Bindcraft_kernel.png){: .invertable style="width:232px"} 

In the notebook you can check the modules by checking the output of `! module list` which should look like that:

![Screenshot](../images/tutorial/bwVisu_Bindcraft_modules_list.png){: .invertable style="width:520px"}
...
![Screenshot](../images/tutorial/bwVisu_Bindcraft_output.png){: .invertable style="width:268px"}
